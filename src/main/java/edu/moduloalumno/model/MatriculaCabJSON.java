...
public class MatriculaCabJSON implements Serializable {
    ...
    public MatriculaCabJSON() {

    }

    public MatriculaCabJSON(String cod_alumno, Integer id_programa, String semestre, Integer ciclo) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MatriculaCabJSON other = (MatriculaCabJSON) obj;
        if (cod_alumno == null) {
