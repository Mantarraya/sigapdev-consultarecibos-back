...
public class AlumnoMatriculaAutorizacionJSON implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AlumnoMatriculaAutorizacionJSON other = (AlumnoMatriculaAutorizacionJSON) obj;
		if (id_autorizacion == null) {
			if (other.id_autorizacion != null)
				return false;
		} else if (!id_autorizacion.equals(other.id_autorizacion))
			return false;
		return true;
	}
